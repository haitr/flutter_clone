...
final class OutlinedButton extends Wrapper {
  @Goto(_i1.OutlinedButton.new)
  OutlinedButton(
    $ $config, {
    _i2.Key? key,
    ...
    _i1.IconAlignment iconAlignment = _i1.IconAlignment.start,
          ...
          builder: (args) => _i1.OutlinedButton(
            key: args(#key),
  ...
  OutlinedButton.icon(
    ...
    _i1.IconAlignment iconAlignment = _i1.IconAlignment.start,
          ...
          builder: (args) => _i1.OutlinedButton.icon(
            key: args(#key),
            onPressed: args(#onPressed),
            onLongPress: args(#onLongPress),
            onHover: args(#onHover),
