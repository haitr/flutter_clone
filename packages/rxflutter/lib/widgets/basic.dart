...
final class Semantics extends Wrapper {
  ...
  Semantics({
    ...
    Stream<_i7.SemanticsSortKey?>? $sortKey,
    // Associate with tagForChildren
    Stream<_i7.SemanticsTag?>? $tagForChildren,
    ...
    Stream<_i7.MoveCursorHandler?>? $onMoveCursorForwardByCharacter,
    // Associate with onMoveCursorBackwardByCharacter
    Stream<_i7.MoveCursorHandler?>? $onMoveCursorBackwardByCharacter,
    // Associate with onSetSelection
    Stream<_i7.SetSelectionHandler?>? $onSetSelection,
    // Associate with onSetText
    Stream<_i7.SetTextHandler?>? $onSetText,
    ...
    Stream<Map<_i7.CustomSemanticsAction, ui.VoidCallback>?>? $customSemanticsActions,
  }) : super(
          Argument(
            {
              'key': key,
  ...
  Semantics.fromProperties({
    ...
    Stream<_i7.SemanticsProperties>? $properties,
  }) : super(
          Argument(
            {
              'key': key,
...
final class RawImage extends Wrapper {
  ...
  RawImage({
    ...
    Stream<ui.Color?>? $color,
    // Associate with opacity
    Stream<_i8.Animation<double>?>? $opacity,
