...
//         origin,
//         name,
//         TypeDefiningMetadata.from(node.type),
...
//   late TypeDefiningMetadata type;
...
//               .map((e) => (e.name?.toString(), TypeDefiningMetadata.from(e.type)!))
//               .toList(),
//     );
//   }

//   /// Processes a named type and creates a [TypeDefiningMetadata].
//   @override
//   void visitNamedType(NamedType node) {
//     super.visitNamedType(node);
//     final typeIndex = node.importPrefix != null ? 1 : 0;
//     final name = node.childEntities.elementAt(typeIndex).toString();
//     type = TypeDefiningMetadata(
//       name: name,
//       nullable: node.question != null,
//       arguments: node.typeArguments?.arguments.fold([], (previousValue, element) {
//         if (TypeDefiningMetadata.from(element) case var analyzer?) {
...
//   final TypeDefiningMetadata? potentialType;
...
//         name,
//         from: TypeDefiningMetadata.fromString(parent!.name),
//         identifier: name,
//       );
//     } else {
...
//     result = DefaultValueEnumOrStaticInstance(
//       node.toString(),
//       from: TypeDefiningMetadata.fromString(node.prefix.toString()),
...
//     result = DefaultValueEnumOrStaticInstance(
//       node.toString(),
//       from: TypeDefiningMetadata.fromString(target),
...
//     TypeDefiningMetadata.fromString(typeName);
...
//       node.toString(),
//       from: TypeDefiningMetadata.fromString(typeName),
