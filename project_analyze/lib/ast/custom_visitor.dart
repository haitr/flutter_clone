...
class CustomAstVisitor implements AstVisitor<void> {
  /// Whether to print verbose output about each node
  final bool verbose;

  /// Whether to recursively visit child nodes
  final bool recursive;

  /// Initialize a newly created visitor.
  CustomAstVisitor({this.verbose = true, this.recursive = true});

  /// Logs information about the node and optionally visits its children
  void _logAndVisitChildren(AstNode node) {
    if (verbose) {
      ...
      SimpleLogger.info('Visit visit$typeName with node: $node');
    }
